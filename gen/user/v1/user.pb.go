...
type User struct {
	...
	CreatedAt     *_type.Timestamp       `protobuf:"bytes,4,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt     *_type.Timestamp       `protobuf:"bytes,5,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
...
func (x *User) GetCreatedAt() *_type.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *User) GetUpdatedAt() *_type.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x1bgoogle/type/timestamp.proto\"\xb6\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x125\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x16.google.type.TimestampR\tcreatedAt\x125\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x16.google.type.TimestampR\tupdatedAt\"\x11\n" +
	"\x0fAllUsersRequest\"7\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2\x99\x01\n" +
	"\vUserService\x12A\n" +
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*AllUsersRequest)(nil),    // 1: user.v1.AllUsersRequest
	(*AllUsersResponse)(nil),   // 2: user.v1.AllUsersResponse
	(*CreateUserRequest)(nil),  // 3: user.v1.CreateUserRequest
	(*CreateUserResponse)(nil), // 4: user.v1.CreateUserResponse
	(*_type.Timestamp)(nil),    // 5: google.type.Timestamp
}
var file_user_v1_user_proto_depIdxs = []int32{
	5, // 0: user.v1.User.created_at:type_name -> google.type.Timestamp
	5, // 1: user.v1.User.updated_at:type_name -> google.type.Timestamp
	0, // 2: user.v1.AllUsersResponse.users:type_name -> user.v1.User
	0, // 3: user.v1.CreateUserResponse.user:type_name -> user.v1.User
	1, // 4: user.v1.UserService.AllUsers:input_type -> user.v1.AllUsersRequest
	3, // 5: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserRequest
	2, // 6: user.v1.UserService.AllUsers:output_type -> user.v1.AllUsersResponse
